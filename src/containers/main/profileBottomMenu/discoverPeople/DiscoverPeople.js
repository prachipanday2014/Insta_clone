        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <View style={styles.headerText}>
                    <Text style={{ fontWeight: "bold", color:"white" }}>Connect to Facebook</Text>
            ...
            <View style={{ top: 50 }}>
                <Text 
                style={{ fontSize: 16, fontWeight: "bold", left: 15, color:"white" }}>
                        ...
                        return (
                            <View style={{ marginVertical: 8, justifyContent: "space-between", top: 20, flexDirection: "row" }}>
                                ...
                                <View style={{ flexDirection: "column", right: 40 }}>
                                    <Text style={{ fontSize: 15, color:"white" }}>user_1</Text>
            ...
            <View style={{ top: 90 }}>
                <Text style={{ fontSize: 16, fontWeight: "bold", left: 15, color:"white" }}>
                    All suggestions
                    </Text>
